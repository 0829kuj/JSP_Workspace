...
<body>
        ...
        <div class="col-lg-5 col-md-7 mx-auto">
          <div class="bg-light p-5 mt-5">
            <form action="<%=request.getContextPath()%>/order?cmd=userSave&id=<c:out value='${order.orderID}'/>" method="post">
              ...
              <input type="text" class="form-control mb-3" name="userName" placeholder="주문번호" value=<c:out value="${order.orderNum}" /> maxlength="20" required />
    ...
    <a href="<%=request.getContextPath()%>/order?cmd=myorders&id=<c:out value='${userID}'/>">주문내역으로</a>
