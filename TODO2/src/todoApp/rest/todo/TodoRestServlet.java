...
//		out.flush();
	...
	private String processGetMine(HttpServletRequest req) {
	...
	private String processGetAll(HttpServletRequest req) {
		// 모든 todo레코드 조회
